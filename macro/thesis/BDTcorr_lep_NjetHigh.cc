...
void BDTcorr_lep_NjetHigh()
{
    ...
    MakeCorr( Tsig, "BDTcorr_lep_NjetHigh.root", "hcorr_sig", "Leptonic signal (N^{jet} #geq 2)" );
    cout << "Processing background\n";
    MakeCorr( Tbkg, "BDTcorr_lep_NjetHigh.root", "hcorr_bkg", "Leptonic bkg (N^{jet} #geq 2)" );
}
