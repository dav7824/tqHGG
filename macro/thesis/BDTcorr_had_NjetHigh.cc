...
void BDTcorr_had_NjetHigh()
{
    ...
    MakeCorr( Tsig, "BDTcorr_had_NjetHigh.root", "hcorr_sig", "Hadronic signal (N^{jet} #geq 4)" );
    cout << "Processing background\n";
    MakeCorr( Tbkg, "BDTcorr_had_NjetHigh.root", "hcorr_bkg", "Hadronic bkg (N^{jet} #geq 4)" );
}
