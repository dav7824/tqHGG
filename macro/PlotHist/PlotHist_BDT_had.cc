...
// Set input dir name
TString indir_name = "BDT_input_had";
...
void PlotHist_BDT_had()
{
    ...
    // DiPhotonJetsBox
    CloneHisto( hsample["DiPhotonJetsBox_scaled"], hbkg["DiPhotonJetsBox"] );
    ...
    // Total bkg
    vector<TH1D*> htotbkg;
    CloneHisto( hsample["DiPhotonJetsBox_scaled"], htotbkg );
