...
void PlotHist_lep()
{
    ...
    TString outdir = dir_res + indir_name + "/plots/";
    ...
    // TT_hct
    CloneHisto( hsample["TT_FCNC-TtoHJ_aTlep_hct"], hsig["TT_hct"] );
    AddHisto( hsig["TT_hct"], hsample["TT_FCNC-aTtoHJ_Tlep_hct"] );
    // TT_hut
    CloneHisto( hsample["TT_FCNC-TtoHJ_aTlep_hut"], hsig["TT_hut"] );
    AddHisto( hsig["TT_hut"], hsample["TT_FCNC-aTtoHJ_Tlep_hut"] );
    // ST_hct
    CloneHisto( hsample["ST_FCNC-TH_Tlep_hct"], hsig["ST_hct"] );
    // ST_hut
    CloneHisto( hsample["ST_FCNC-TH_Tlep_hut"], hsig["ST_hut"] );
    // DiPhotonJetsBox
    CloneHisto( hsample["DiPhotonJetsBox"], hbkg["DiPhotonJetsBox"] );
    // GJet
    CloneHisto( hsample["GJet_Pt-20to40_MGG-80toInf"], hbkg["GJet"] );
    AddHisto( hbkg["GJet"], hsample["GJet_Pt-20toInf_MGG-40to80"] );
    AddHisto( hbkg["GJet"], hsample["GJet_Pt-40toInf_MGG-80toInf"] );
    // QCD
    CloneHisto( hsample["QCD_Pt-30toInf_MGG-40to80"], hbkg["QCD"] );
    AddHisto( hbkg["QCD"], hsample["QCD_Pt-40toInf_MGG-80toInf"] );
    // TGJets
    CloneHisto( hsample["TGJets"], hbkg["TGJets"] );
    // tW
    CloneHisto( hsample["tW_antitop"], hbkg["tW"] );
    AddHisto( hbkg["tW"], hsample["tW_top"] );
    // TTGG
    ...
    // TTV
    CloneHisto( hsample["TTWJetsToLNu"], hbkg["TTV"] );
    AddHisto( hbkg["TTV"], hsample["TTZToLLNuNu"] );
    // DY
    CloneHisto( hsample["DYJetsToLL"], hbkg["DY"] );
    // VG
    CloneHisto( hsample["WGToLNuG"], hbkg["VG"] );
    AddHisto( hbkg["VG"], hsample["ZGToLLG"] );
    // VV
    CloneHisto( hsample["WW"], hbkg["VV"] );
    AddHisto( hbkg["VV"], hsample["WZ"] );
    AddHisto( hbkg["VV"], hsample["ZZ"] );
    // SM Higgs
    ...
    AddHisto( htotbkg, hsample["GJet_Pt-20to40_MGG-80toInf"] );
    AddHisto( htotbkg, hsample["GJet_Pt-20toInf_MGG-40to80"] );
    AddHisto( htotbkg, hsample["GJet_Pt-40toInf_MGG-80toInf"] );
    AddHisto( htotbkg, hsample["QCD_Pt-30toInf_MGG-40to80"] );
    AddHisto( htotbkg, hsample["QCD_Pt-40toInf_MGG-80toInf"] );
    ...
    for (int i=0; i<Nhist; ++i) {
        ...
        hs[i]->Add( hbkg["TTV"][i] );
        hs[i]->Add( hbkg["tW"][i] );
        hs[i]->Add( hbkg["TGJets"][i] );
        hs[i]->Add( hbkg["DiPhotonJetsBox"][i] );
        hs[i]->Add( hbkg["GJet"][i] );
        hs[i]->Add( hbkg["QCD"][i] );
    }
    ...
    for (int i=0; i<Nhist; ++i) {
        ...
        // total bkg
        htotbkg[i]->SetFillColorAlpha(kBlack, 0.4);
