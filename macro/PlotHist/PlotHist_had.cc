...
void PlotHist_had()
{
    ...
    // QCD
    CloneHisto( hsample["QCD_Pt-30to40_MGG-80toInf"], hbkg["QCD"] );
    AddHisto( hbkg["QCD"], hsample["QCD_Pt-30toInf_MGG-40to80"] );
    ...
    AddHisto( htotbkg, hsample["QCD_Pt-30to40_MGG-80toInf"] );
