...
void GetYields_had()
{
    TString indir_name = "Presel_had_phIDSB";
    ...
    float yQCD_Pt_30to40_MGG_80toInf[2];    GetYield(indir, "QCD_Pt-30to40_MGG-80toInf", yQCD_Pt_30to40_MGG_80toInf);
    ...
    AddYield(yQCD_, yQCD_Pt_30to40_MGG_80toInf);
    ...
    PrintYield("QCD_Pt-30to40_MGG-80toInf", yQCD_Pt_30to40_MGG_80toInf);
