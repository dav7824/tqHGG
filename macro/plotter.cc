...
// 1. name of selection
// 2. year of datasets
// 3. (default = "") name of channel
// 4. (default = 0) whether use log scale for y axis
// 5. (default = 0) whether calculate event yields

void plotter(const char *dir_name, int year, TString ch = "", bool use_logy = 0, bool calcYield = 0)
{
    TString indir = TString("/wk_cms2/mc_cheng/public/tqHGG/2017/") + dir_name + "/hist/";
    TString outdir = TString("/wk_cms2/mc_cheng/public/tqHGG/2017/") + dir_name + "/plots/";
    TString normdir = "/wk_cms2/mc_cheng/public/tqHGG/2017/normfactor/";
	...
	out_yield << "(MC - data) / data\t\t" << ratio << " +- " << sqrt(ratio_err2) << endl;
