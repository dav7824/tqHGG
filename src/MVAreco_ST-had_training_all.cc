// Train the models for MVA reconstruction of ST hadronic signal.
//
// input arguments:
...
int main(int argc, char **argv)
{
    ...
    TString indir = "/wk_cms2/mc_cheng/public/tqHGG/2017/MVAreco_ST-had/training/";
    TString outdir = indir + "All/";
    TString inTree_name = "flashggStdTree";

    int Nsample = 2;
    TString sample[Nsample] = {
	"ST_FCNC-TH_Thad_hct", "ST_FCNC-TH_Thad_hut"
    };
    ...
    dataloader->AddVariable("bJet_M1_Pt", 'F');
    dataloader->AddVariable("bJet_M1_Eta", 'F');
    dataloader->AddVariable("bJet_M1_Phi", 'F');
    //dataloader->AddVariable("bJet_M1_E", 'F');
    dataloader->AddVariable("bJet_M1_btag", 'F');
    ...
    TMVA::Factory *factory = new TMVA::Factory("MVAreco_ST-had", fTrainSummary, "V:AnalysisType=Classification");
