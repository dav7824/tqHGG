/*
 * Train BDT for SR definition (leptonic).
 *
 * ./BDTtrain_lep <fins_sig_train> <fins_sig_test> <fins_bkg_train> <fins_bkg_test> <indir_train> <indir_test> <outdir>
 *
...
int main(int argc, char **argv)
{
    ...
    dataloader->SetSignalWeightExpression(
            "genweight*norm*Nscale*SF_pileup*SF_btag*SF_photon*SF_ElecReco*SF_ElecID*SF_MuonID*SF_MuonIso");
    ...
    TString factory_name = "leptonic_SR";
