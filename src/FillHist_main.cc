// Fill histograms and save them.
// This program can be modified and run repeatedly to update the output file.
//
// This code uses only variables from the main tree.
...
int main(int argc, char **argv)
{
	...
	// diphoton
	MakeFillHist(inTree,        "DiPhoInfo.mass", weight, "dipho_mass", "diphoton mass", 40, 100, 500, "GeV");
	...
	// leading photon
	MakeFillHist(inTree,           "DiPhoInfo.leadPt", weight,        "pho1_pt",              "leading #gamma Pt", 40,    0,  360, "GeV");
	...
	MakeFillHist(inTree,            "DiPhoInfo.leadE", weight,         "pho1_E",          "leading #gamma energy", 40,    0, 1000, "GeV");
	...
	// subleading photon
	MakeFillHist(inTree,           "DiPhoInfo.subleadPt", weight,        "pho2_pt",              "subleading #gamma Pt", 40,    0,  360, "GeV");
	...
	MakeFillHist(inTree,            "DiPhoInfo.subleadE", weight,         "pho2_E",          "subleading #gamma energy", 40,    0, 1000, "GeV");
	...
	// jet
	MakeFillHist(inTree,                       "jets_size", weight,      "jet_N",       "jet N", 15, -0.5, 14.5);
	MakeFillHist(inTree,                      "JetInfo.Pt", weight,     "jet_pt",      "jet Pt", 40,    0,  400, "GeV");
	...
	MakeFillHist(inTree,                    "JetInfo.Mass", weight,      "jet_M",    "jet mass", 40,    0,   60, "GeV");
	MakeFillHist(inTree,                  "JetInfo.Energy", weight,      "jet_E",  "jet energy", 40,    0,  800, "GeV");
	...
	// MET
	MakeFillHist(inTree,    "MetInfo.Pt", weight,    "met_pt",          "MET Pt", 40,    0,  200, "GeV");
	MakeFillHist(inTree,   "MetInfo.Phi", weight,   "met_phi",        "MET #phi", 40, -3.5,  3.5);
	MakeFillHist(inTree,    "MetInfo.Px", weight,    "met_px",          "MET Px", 40, -200,  200, "GeV");
	...
	if (channel == "lep" || channel == "all") {
		...
		MakeFillHist(inTree,     "ElecInfo.Pt", weight,  "elec_pt",     "electron Pt", 40,    0,  160, "GeV");
		...
		MakeFillHist(inTree, "ElecInfo.Energy", weight,   "elec_E", "electron energy", 40,    0,  400, "GeV");
		// muon
		...
		MakeFillHist(inTree,                    "MuonInfo.Pt", weight,    "muon_pt",        "muon Pt", 40,    0,  160, "GeV");
		...
		MakeFillHist(inTree,                "MuonInfo.Energy", weight,     "muon_E",    "muon energy", 40,    0,  400, "GeV");
