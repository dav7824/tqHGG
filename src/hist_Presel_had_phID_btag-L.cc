...
// leading photon
MakeFillHist(inTree,           "DiPhoInfo.leadPt", weight,        "pho1_pt",              "leading #gamma Pt", 20,   35,  275, "GeV");
MakeFillHist(inTree,          "DiPhoInfo.leadEta", weight,       "pho1_eta",            "leading #gamma #eta", 20,   -3,    3);
MakeFillHist(inTree,          "DiPhoInfo.leadPhi", weight,       "pho1_phi",            "leading #gamma #phi", 20, -3.5,  3.5);
MakeFillHist(inTree,            "DiPhoInfo.leadE", weight,         "pho1_E",          "leading #gamma energy", 20,    0, 800, "GeV");
MakeFillHist(inTree,        "DiPhoInfo.leadIDMVA", weight,     "pho1_idmva",           "leading #gamma IDMVA", 20,   -1,    1);
MakeFillHist(inTree, "DiPhoInfo.leadhasPixelSeed", weight, "pho1_PixelSeed",  "leading #gamma has pixel seed",  2,    0,    2);
// subleading photon
MakeFillHist(inTree,           "DiPhoInfo.subleadPt", weight,        "pho2_pt",              "subleading #gamma Pt", 20,   25,  145, "GeV");
MakeFillHist(inTree,          "DiPhoInfo.subleadEta", weight,       "pho2_eta",            "subleading #gamma #eta", 20,   -3,    3);
MakeFillHist(inTree,          "DiPhoInfo.subleadPhi", weight,       "pho2_phi",            "subleading #gamma #phi", 20, -3.5,  3.5);
MakeFillHist(inTree,            "DiPhoInfo.subleadE", weight,         "pho2_E",          "subleading #gamma energy", 20,    0, 320, "GeV");
MakeFillHist(inTree,        "DiPhoInfo.subleadIDMVA", weight,     "pho2_idmva",           "subleading #gamma IDMVA", 20,   -1,    1);
...
MakeFillHist(inTree,                      "JetInfo.Pt", weight,     "jet_pt",      "jet Pt", 20,   25,  225, "GeV");
MakeFillHist(inTree,                     "JetInfo.Eta", weight,    "jet_eta",    "jet #eta", 20,   -3,    3);
MakeFillHist(inTree,                     "JetInfo.Phi", weight,    "jet_phi",    "jet #phi", 20, -3.5,  3.5);
MakeFillHist(inTree,                    "JetInfo.Mass", weight,      "jet_M",    "jet mass", 20,    0,   40, "GeV");
MakeFillHist(inTree,                  "JetInfo.Energy", weight,      "jet_E",  "jet energy", 20,    0,  500, "GeV");
MakeFillHist(inTree,  "JetInfo.pfDeepCSVJetTags_probb", weight,  "jet_probb",  "jet prob_b", 20,    0,    1);
MakeFillHist(inTree, "JetInfo.pfDeepCSVJetTags_probbb", weight, "jet_probbb", "jet prob_bb", 20,    0,    1);
// MET
MakeFillHist(inTree,    "MetInfo.Pt", weight,    "met_pt",          "MET Pt", 20,    0,  140, "GeV");
MakeFillHist(inTree,   "MetInfo.Phi", weight,   "met_phi",        "MET #phi", 20, -3.5,  3.5);
MakeFillHist(inTree,    "MetInfo.Px", weight,    "met_px",          "MET Px", 20, -150,  150, "GeV");
MakeFillHist(inTree,    "MetInfo.Py", weight,    "met_py",          "MET Py", 20, -150,  150, "GeV");
MakeFillHist(inTree, "MetInfo.SumET", weight, "met_sumET", "MET E_{T}^{sum}", 20,    0, 4000, "GeV");
/*
