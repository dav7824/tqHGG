...
int main(int argc, char **argv)
{
    ...
    for (int evt=0; evt<Nevt_tot; ++evt)
    {
        ...
        /* The remaining part of event loop is for training events only */

        // If there is any matched permutations, randomly choose one of them to save
        vector<IdxPerm_TThad> train_perms;  // Vector of permutations to be sampled for training
