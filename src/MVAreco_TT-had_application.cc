// Applying trained models for reconstruction of hadronic TT signal to bkg MC and data.
//
// input arguments:
...
int main(int argc, char **argv)
{
    ...
    inTree->SetBranchAddress("idx_M1jet", &idx_M1jet);
    inTree->SetBranchAddress("idx_M2bjet", &idx_M2bjet);
    ...
    inTree->SetBranchAddress("bJet_M2_Pt", &bJet_M2_Pt);
    inTree->SetBranchAddress("bJet_M2_Eta", &bJet_M2_Eta);
    inTree->SetBranchAddress("bJet_M2_Phi", &bJet_M2_Phi);
    inTree->SetBranchAddress("bJet_M2_E", &bJet_M2_E);
    inTree->SetBranchAddress("bJet_M2_btag", &bJet_M2_btag);
    inTree->SetBranchAddress("Jet_M1_Pt", &Jet_M1_Pt);
    inTree->SetBranchAddress("Jet_M1_Eta", &Jet_M1_Eta);
    inTree->SetBranchAddress("Jet_M1_Phi", &Jet_M1_Phi);
    inTree->SetBranchAddress("Jet_M1_E", &Jet_M1_E);
    inTree->SetBranchAddress("Jet_M1_btag", &Jet_M1_btag);
    ...
    outTree->Branch("idx_M1jet", &idx_M1jet);
    outTree->Branch("idx_M2bjet", &idx_M2bjet);
    outTree->Branch("InvMass_W", &InvMass_W);
    outTree->Branch("InvMass_M1", &InvMass_M1);
    outTree->Branch("InvMass_M2", &InvMass_M2);
    outTree->Branch("bJet_M2_Pt", &bJet_M2_Pt);
    outTree->Branch("bJet_M2_Eta", &bJet_M2_Eta);
    outTree->Branch("bJet_M2_Phi", &bJet_M2_Phi);
    outTree->Branch("bJet_M2_E", &bJet_M2_E);
    outTree->Branch("bJet_M2_btag", &bJet_M2_btag);
    outTree->Branch("Jet_M1_Pt", &Jet_M1_Pt);
    outTree->Branch("Jet_M1_Eta", &Jet_M1_Eta);
    outTree->Branch("Jet_M1_Phi", &Jet_M1_Phi);
    outTree->Branch("Jet_M1_E", &Jet_M1_E);
    outTree->Branch("Jet_M1_btag", &Jet_M1_btag);
