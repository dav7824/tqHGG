...
MakeFillHist(inTree,          "DiPhoInfo.pt", weight,   "dipho_pt",   "diphoton Pt", 40,   0, 160, "GeV");
MakeFillHist(inTree, "DiPhoInfo.diphotonMVA", weight,  "dipho_mva",  "diphoton MVA", 40,  -1,   1);
// leading photon
MakeFillHist(inTree,           "DiPhoInfo.leadPt", weight,        "pho1_pt",              "leading #gamma Pt", 40,   35,  235, "GeV");
...
MakeFillHist(inTree,            "DiPhoInfo.leadE", weight,         "pho1_E",          "leading #gamma energy", 40,    0, 600, "GeV");
...
// subleading photon
MakeFillHist(inTree,           "DiPhoInfo.subleadPt", weight,        "pho2_pt",              "subleading #gamma Pt", 40,   25,  185, "GeV");
...
MakeFillHist(inTree,            "DiPhoInfo.subleadE", weight,         "pho2_E",          "subleading #gamma energy", 40,    0, 400, "GeV");
...
MakeFillHist(inTree,                      "JetInfo.Pt", weight,     "jet_pt",      "jet Pt", 40,   25,  185, "GeV");
...
MakeFillHist(inTree,                  "JetInfo.Energy", weight,      "jet_E",  "jet energy", 40,    0,  400, "GeV");
